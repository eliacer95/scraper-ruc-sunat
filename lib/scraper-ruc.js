...
function getBasicInformation(html , callback) {
	...
	try {
		...
		var objeto = {
			...
			condition			: contributor.condition.toString(),
			fiscal_address: contributor.fiscal_address.toString()
		}
...
function getExtendedInformation(html , callback) {
	try {
		...
		var objeto = {
			economic_activities	: contributor.economic_activities.toString(),
			authorized_vouchers	: contributor.authorized_vouchers.toString(),
			electronic_vouchers	: contributor.electronic_vouchers.toString(),
